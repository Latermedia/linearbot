...
<div class="space-y-6">
	...
	<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
		<div>
			<h2 class="text-2xl font-semibold tracking-tight text-white">Project Timeline</h2>
			<p class="text-neutral-400 text-sm mt-1">View active projects across teams and domains</p>
		</div>
	...
	{:else if error}
		<Card class="border-red-500/50">
			<div class="font-semibold text-red-400 mb-3">Error Loading Data</div>
			<p class="text-neutral-400 mb-3">{error}</p>
			<p class="text-sm text-neutral-500">
				Make sure the database is synced. Run: <code class="bg-neutral-800 px-2 py-1 rounded font-mono text-neutral-300"
					>bun run sync</code
				>
			</p>
		</Card>
	{:else if teams.length === 0}
		<Card>
			<div class="font-semibold text-white mb-3">No Projects Found</div>
