<script lang="ts">
  ...
  async function loadTeams() {
    if (!browser) return;
    pageLoading.startLoading("/organization");
    try {
      loading = true;
      error = null;
      ...
      loading = false;
      pageLoading.stopLoading("/organization");
    }
  }
...
<div class="p-6 space-y-6">
  ...
  >
    <div>
      <h1
        class="text-2xl font-semibold tracking-tight text-black-900 dark:text-black-900 dark:text-white"
      >
        Organization
      </h1>
