...
import { verifyPassword, createSession, getSessionCookieName, getSessionDuration } from '$lib/auth.js';
...
export const POST: RequestHandler = async ({ request, cookies }) => {
	try {
		...
		const isSecure = process.env.VERCEL_ENV === 'production' || process.env.VERCEL_ENV === 'preview';
