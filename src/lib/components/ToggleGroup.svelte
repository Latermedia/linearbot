<script lang="ts" module>
  ...
  export function toggleVariants(variant: Variant, size: Size = "default") {
    ...
    const variants = {
      ...
      outline:
        "hover:bg-neutral-50 dark:hover:bg-white/5 data-[state=on]:bg-transparent data-[state=on]:text-neutral-900 dark:data-[state=on]:text-white text-neutral-600 dark:text-neutral-400 bg-transparent rounded-md",
    };
