...
{#snippet childrenSnippet()}
  <div class="space-y-6">
    ...
    <div class="space-y-3">
      <div class="flex gap-2 items-center text-danger-400">
      ...
      {#if resetSuccess}
        <p class="text-xs text-success-400">Database reset successfully</p>
      {/if}
      {#if resetError}
        <p class="text-xs text-danger-400">{resetError}</p>
      {/if}
      ...
      <div class="space-y-2">
        <input
          ...
          class="px-2.5 py-1.5 w-full text-xs text-white rounded bg-black-800/50 placeholder-black-600 focus:outline-none focus:ring-1 focus:ring-danger-500/50"
        ...
        <div class="flex gap-2">
          <button
            ...
            class="flex-1 px-3 py-1.5 text-xs transition-colors cursor-pointer text-black-400 hover:text-black-900 dark:text-white"
          >
            Clear
          </button>
          <button
            ...
            class="flex-1 px-3 py-1.5 text-xs text-danger-400 rounded transition-colors cursor-pointer bg-danger-500/10 hover:bg-danger-500/20 disabled:opacity-40 disabled:cursor-not-allowed"
          >
